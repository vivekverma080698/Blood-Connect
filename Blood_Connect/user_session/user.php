...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <nav id="nav">
          <ul class="main-menu nav navbar-nav navbar-right">
            ...
            <li><a href="kreceiver.php">Recipient</a></li>
    ...
    <div id="home" class="hero-area">
      ...
      <!-- Backgound Image -->
      <div class="bg-image bg-parallax overlay" style="background-image:url(./img2/donate-blood.png)"></div>
      <!-- /Backgound Image -->
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <p class="lead white-text">O Negative blood cells are called “universal” meaning they can be transfused to almost any patient in need, and only 6.6% of the population has O Negative blood.</p>
    ...
    <div id="why-us" class="section">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="feature">
              ...
              <div class="feature-content">
                ...
                <p>Donate blood and save lives. Fix an appointment for blood donation.</p>
              </div>
            </div>
          </div>
          <!-- /feature -->
          ...
          <div class="col-md-4">
            <div class="feature">
              <i class="feature-icon fa fa-hospital-o"></i>
              <div class="feature-content">
                <h4>Donate In Nearest Hospital</h4>
                <p>Find hospitals near your location. Donate blood easily and safely.</p>
              </div>
            </div>
          </div>
          <!-- /feature -->
          ...
          <div class="col-md-4">
            <div class="feature">
              ...
              <div class="feature-content">
                <h4>Organize Blood Drive</h4>
                <p>Host a blood drive. You can contact hospital for blood drive.</p>
              </div>
            </div>
          </div>
          <!-- /feature -->
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="feature">
              ...
              <div class="feature-content">
                ...
                <p>Find the nearest hospital for blood.</p>
              </div>
            </div>
          </div>
          <!-- /feature -->
          ...
          <div class="col-md-4">
            <div class="feature">
              <i class="feature-icon fa fa-h-square"></i>
              <div class="feature-content">
                <h4>Shortest Path</h4>
                <p>Find the shortest path to your hospital from your location.</p>
              </div>
            </div>
          </div>
          <!-- /feature -->
          ...
          <div class="col-md-4">
            <div class="feature">
              <i class="feature-icon fa fa-ambulance"></i>
              <div class="feature-content">
                <h4>Emergency Services</h4>
                <p>Emergency services are also provided. You can find hospitals near you for blood anytime.</p>
              </div>
            </div>
          </div>
          <!-- /feature -->
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <p class="lead"></p>
            <p>Information about blood. See which blood groups can be used for donating blood to other blood group.</p>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-8 col-md-offset-2 text-center">
            ...
            <a class="main-button icon-button" href="#">Connect With Us Now</a>
          </div>

...
<!-- Contact -->
    ...
    <h3>Please fill in this form to log in your account.</h3>
...
<form action="" method="post">
  ...
  <div class="container">
    ...
    <button type="submit" name = "submit" style="color: black">Login</button>
    <label>
  ...
  <div class="container" style="background-color:#f1f1f1">
    ...
    <input type="button" onclick="location.href='fhomepage.php';" value="Back" />

...
-->
  ...
  <body>
    ...
    <div class="hero-area section">
      ...
      <!-- Backgound Image -->
      <div class="bg-image bg-parallax overlay" style="background-image:url(./img/hospital3.jpg)"></div>
      <!-- /Backgound Image -->

      <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-1 text-center">
            <h1 class="white-text">Fixed Appointments</h1>
         </div>
        </div>
      </div>
   ...
   <?php
         ...
         $query2 = "SELECT user_id,starting_date,ending_date,final_date,starting_time,ending_time,final_time from appointment where hospital_id = '$num' and Hospital_pending = 0 and final_date >= CURDATE()" ; 
  ...
  echo  '<div class="w3-row  w3-center w3-display-container w3-row-padding" style="height:100%">';
    ...
    echo "<h1 style=\"margin-left: auto; margin-right: auto ;\" >$name </br></h1> ";
     ...
     echo  '<div class="container w3-center" style="margin-left: auto;width:80%; margin-right: auto "style="height:100%">';
       if ($result ->num_rows > 0)
                {
 //    echo  '<div class="container w3-center w3-yellow" style="margin-left: auto; margin-right: auto ;width:40%;height:100% ">';
        echo "<table class = \"w3-center\"id = \"AppTable\" width=100% bgcolor=\"#f0ffff\" cellpadding=\"15\" cellspacing=\"20\"  style=\"empty-cells: hide; margin-left:auto; margin-right: auto ;\">";
            echo    "<tr>";

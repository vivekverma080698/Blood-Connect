...
<html lang="en">
	...
	<body>
		...
		<header id="header" class="transparent-nav">
            ...
            <li><a href="hos_homepage.php">Hi <?php echo htmlspecialchars($_SESSION['username']); ?></a></li>
            <li><a href="hos_homepage.php">Home</a></li>
            <li><a href="">About Us</a></li>
            <li><a href="contact.php">Contact Us</a></li>
            <li><a href="sample.php">Information</a></li>
			...
			<!-- /Backgound Image -->
				...
				<div class="container">
					<div class="row">
						...
						<h1 class="white-text">Spread the message of blood donation</h1>
						<p class="white-text">Be a blood donor-</p>
					</div>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="contact-form">
							<h4>About Blood Connect </h4>
							<p>Blood cannot be manufactured in factories; it can only come from generous donors.According to WHO data, India faces a shortage of 3 million blood units. This shortage can easily be eliminated if only an additional 2% of India's youth donates blood. To make this possible, BloodConnect acts as a channel connecting voluntary blood donors with those who need blood. It is currently a project under IIT ROPAR which aims organization and provides free help and specially works to target the patient and the needy. </p>
							
							<p>According to WHO data, India faces a shortage of 3 million blood units. This shortage can easily be eliminated if only an additional 2% of India's youth donates blood. To make this possible, BloodConnect acts as a channel connecting voluntary blood donors with those who need blood. It is a youth-run organization and provides free help and specially works to target the poor and the needy. </p>
						</div>
					</div>
					<!-- /contact form -->

					<!-- contact information -->
					<div class="col-md-5 col-md-offset-1" style="display:block;padding:10px">
						<img width="200px" height="200px" src="../author/vivek.jpg" alt="Blood image" style="padding:10px">
						
						<img width="200px" height="200px" src="../author/ram.jpg" alt="Blood image" style="padding:10px">
						

					</div>
					
					<div class="col-md-5 col-md-offset-1" style="display:block;padding:10px">
						<img width="200px" height="200px" src="../author/komal.jpg" alt="Blood image" style="padding:10px">
						<img width="200px" height="200px" src="../author/prasad.jpg" alt="Blood image" style="padding:10px">
